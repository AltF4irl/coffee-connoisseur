...
export default function Banner({ onClickHandler, buttonContent }: BannerProps) {
  return (
    <div className="mb-12 grid lg:mb-24 lg:grid-cols-2">
      <div className="z-20 flex flex-col px-2 md:pt-12">
        ...
        <p className="font-sans text-xl font-semibold text-gray-900 md:mt-5 lg:text-exl">
          Discover Coffee Shops Near You!
        </p>
        <div className="mt-12">
          <button onClick={onClickHandler}>{buttonContent}</button>
        </div>
      </div>
